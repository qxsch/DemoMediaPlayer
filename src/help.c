...
static const wchar_t s_help_tagged[] =
    ...
    L"  <k>1</k>            Volume +" LS(VOLUME_STEP_PCT) L"% <d>(max " LS(VOLUME_MAX_PCT) L"%)</d>\r\n"
    L"  <k>7</k>            Volume -" LS(VOLUME_STEP_PCT) L"% <d>(min " LS(VOLUME_MIN_PCT) L"%)</d>\r\n"
    L"  <k>M</k>            Toggle volume <d>(mute / unmute)</d>\r\n"
    L"\r\n"
    L"  <k>4</k>            Pan left\r\n"
    L"  <k>6</k>            Pan right\r\n"
    L"  <k>8</k>            Pan up\r\n"
    ...
    L"  <k>A</k>            Reset all <d>(zoom, pan, speed, volume)</d>\r\n"
    L"\r\n"
    ...
    L"    <k>Elapsed time</k>         <d>HH:MM:SS display during recording</d>\r\n"
    L"\r\n"
    L"<h>Global hotkeys:</h>\r\n"
    L"  <k>Ctrl+F9</k>      Start / stop recording\r\n"
    L"  <k>Ctrl+F10</k>     Pause / resume recording\r\n"
    L"\r\n"
    L"<h>Encoding:</h>\r\n"
